...
print("Installing...")
try:
    urllib.request.urlretrieve("https://github.com/ArjunSahlot/fake_bpy/archive/main.zip", tmp)
    file += "main"
except urllib.error.HTTPError:
    urllib.request.urlretrieve("https://github.com/ArjunSahlot/fake_bpy/archive/master.zip", tmp)
    file += "master"
